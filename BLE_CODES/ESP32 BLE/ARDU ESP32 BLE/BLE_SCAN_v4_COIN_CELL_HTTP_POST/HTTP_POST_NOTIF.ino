String DH_SERVER_IP = "10.208.37.184"; //ifconfig
...
//    if((wifiMulti.run() == WL_CONNECTED))  // wait for WiFi connection
    if(WiFi.status() == WL_CONNECTED)
    {
        ...
        String data = "{\"notification\": \"sensordata\",\"timestamp\": \"2019-09-12T10:25:34.444Z\",\"parameters\": {\"temp\":\"";  //+ tempC+ ",\"humi\":"+ humidity+ ",\"lux\":"+ lux+ "}}";
...
//        String data = "{\"notification\": \"sensordata\",\"timestamp\": \"2019-07-18T12:25:34.444Z\",\"parameters\": {\"50:8c:b1:40:16:47\":\"1\", \"98:5d:ad:23:14:bd\":\"0\"}}";
        ...
        Serial.print("\n[HTTP] POST DATA: \t");
        Serial.println(data);
        int httpCode =  http.POST(data);    delay(500);
