...
//    DynamicJsonBuffer jsonBuffer(bufferSize);
    ...
    StaticJsonBuffer<JSON_BUFFER_SIZE_BYTES> jsonBuffer; // Memory pool for JSON object tree. 200 is the size of the pool in bytes.
...
//    
    JsonObject& configuration = root.createNestedObject("configuration");
