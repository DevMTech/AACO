...
void DEEPSLEEP_setup(uint8_t SLEEP_SECONDS){
//  Serial.begin(115200);
//  delay(1000); //Take some time to open up the Serial Monitor
  ...
  /*
  First we configure the wake up source - TIMER WAKE UP
  We set our ESP32 to wake up every 5 seconds
  */
  
  esp_sleep_enable_timer_wakeup(SLEEP_SECONDS * uS_TO_S_FACTOR);
  Serial.println("Setup ESP32 to sleep for every " + String(SLEEP_SECONDS) +  " Seconds");
