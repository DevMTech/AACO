...
void CO2_I2C_CCS811_setup(void * parameter)
{
  //  Serial.begin(115200); // Enable serial

  Serial.print("CO2_I2C_CCS811_setup Task running on core ");
  ...
  if (CCS811_flag)
  {
    ...
    while (loop_count < 10)
    {
      ...
      if ((eCO2 > 0 && eCO2 < 10000) && (tVOC > 0 && tVOC < 10000)) // (eCO2 || tVOC)
