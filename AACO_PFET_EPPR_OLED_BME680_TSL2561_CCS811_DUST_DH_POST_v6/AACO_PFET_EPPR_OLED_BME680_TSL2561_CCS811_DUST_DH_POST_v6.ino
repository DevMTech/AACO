...
#ifdef ESP32
#define LED_BUILTIN 2 // GPIO2 ESP32
...
//const char* ssid = "Xperia";        const char* password = "Hello1214";
//const char* ssid = "ASUS_X00TD";    const char* password = "4652b298f";
const char* ssid  = "NeMo";                   const char* password  = "19stm3289";
const char* ssid1 = "ASUS_X00TD";             const char* password1 = "4652b298f";
const char* ssid2 = "Airtel-Hotspot-6B0F";    const char* password2 = "nf7ndtif";
...
void loopOnce()
{
  ...
  BME680_Simple_loop();   //  BME680_Air_Q_loop();
  delay(50);

  LUX_TSL2561_loop(); //  LUX_BH1750_loop();
  delay(50);

  // HDC1080_loop();

  // CO2_I2C_CCS811_loop();   delay(50);

  // SDS011_DUST_loop();  delay(50);
...
void WiFi_setup()
{
  ...
  while (wifiMulti.run() != WL_CONNECTED && c++ < 100)
