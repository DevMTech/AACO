...
//POST data to Server
bool postData(String path, int sw, int press_type)
{
  HTTPClient httpPost;  
  ...
  String st_ptype = String(press_type);
  //String st_s = String(s);
  
  Serial.println("pointID: " + st_sw + ", pressType: " + st_ptype + ", pointsSubmit: 1");
  //int httpCode = httpPost.POST("pointID=" + st_sw + "&" + "pressType=" + st_ptype + "&" +"pointsSubmit=1");
...
void setup() 
{
  ...
  buttons.attachClick(click1);
  buttons.attachDoubleClick(doubleclick1);
  //buttons.attachLongPressStart(longPressStart1);
  //buttons.attachLongPressStop(longPressStop1);
  buttons.attachDuringLongPress(longPress1);
...
void button_pressed(int press_type)
{ String button_msg;
  int flag=1;
  ...
  {   //point.pointID = sw;
     ...
     if(postData(post, sw, press_type))
     //if(postData(post, sw, s_map))
        digitalWrite(LED_BUILTIN, HIGH);
        
        switch(press_type)
        {
          case 1: button_msg = "single pressed";      break;
          case 2: button_msg = "double pressed";      break;
          case 3: button_msg = "long press started";  break;
          case 4: button_msg = "long pressed";        break;
          case 5: button_msg = "long press ended";    break;
          default: flag=0; break;
        }     

     if(flag)
     {  Serial.print(String(" -> switch ")+(sw)+ String(" ") + button_msg); 
      }
  }
