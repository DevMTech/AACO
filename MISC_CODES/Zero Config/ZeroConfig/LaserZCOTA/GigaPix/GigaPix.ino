...
//Server address
String DEV_REG_host;// = "http://"+restUrl +":"+ restPort;
//const char* DEV_REG_host = "http://"+restUrl + restPort;
//const char* DEV_REG_host = "http://10.42.0.1:3301"; // office laptop

//Post service Path
String devRegPostPath = "/registerDevice";
...
/**/ //Device registration - HTTP POST - SHOULD HAPPEN ONLY AFTER ZERO CONFIG REBOOT
  if (WiFi.status() == WL_CONNECTED) //CHECK CONDITION - SHOULD EXECUTE AFTER SUCCESSFUL CONECTION TO HOTSPOT
  {    
    deviceName="GigaPix";
    ...
    DEV_REG_host = "http://"+restUrl +":"+ restPort;
    Debug("\n\n\t Host Url : ");
