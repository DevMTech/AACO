...
void webHandleConfig(){
  ...
  s += "<label>REST URL: </label><input name='restUrl' length=64></br>";
  s += "<label>PORT: </label><input name='restPort' length=8></br>";
...
void webHandleConfigSave(){
  ...
  String qUrl;
  qUrl = server.arg("restUrl");
  qUrl.replace("%2F","/");
  Serial.println("Got restUrl: " + qUrl);
  restUrl = (char*) qUrl.c_str();

//  restUrl = (char*) server.arg("restUrl").c_str();
//  Serial.print("Got restUrl: ");
