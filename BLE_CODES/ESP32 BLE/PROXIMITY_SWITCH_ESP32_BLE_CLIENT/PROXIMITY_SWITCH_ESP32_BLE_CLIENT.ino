...
//"98:5d:ad:23:14:bd"; // JDY-08 COIN CELL
...
String BLE_Tag_Addr_to_Scan = "98:5d:ad:23:14:bd"; // JDY-08 COIN CELL
...
//String BLE_Tag_Addr_to_Scan = "c8:fd:19:4b:4d:8f"; //Hardware Bluetooth MAC of my BLE_SERVER_TAG, will vary for every band obtained through nRF connect application 
//static BLEUUID serviceUUID("0000fee0-0000-1000-8000-00805f9b34fb"); //Service UUID of BLE_SERVER_TAG obtained through nRF connect application 
//static BLEUUID    charUUID("0000fee1-0000-1000-8000-00805f9b34fb"); //Characteristic  UUID of BLE_SERVER_TAG obtained through nRF connect application 
...
bool connectToserver (BLEAddress pAddress) // REMOTE SERVER (BLE TAG) ADDR
{
    ...
    pClient->connect(pAddress); // REMOTE SERVER ADDR
    Serial.println(" - Connected to BLE_SERVER_TAG");
