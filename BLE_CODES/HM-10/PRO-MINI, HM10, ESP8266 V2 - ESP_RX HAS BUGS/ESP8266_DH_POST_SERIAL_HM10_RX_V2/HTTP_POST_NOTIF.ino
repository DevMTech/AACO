String DH_SERVER_IP = "10.208.22.68"; //ifconfig
...
//    if((wifiMulti.run() == WL_CONNECTED))  // wait for WiFi connection
    if(WiFi.status() == WL_CONNECTED)
    {
        ...
        String data = "{\"notification\": \"sensordata\",\"timestamp\": \"2019-08-29T12:25:34.444Z\",\"parameters\": {\"temp\":";  //+ tempC+ ",\"humi\":"+ humidity+ ",\"lux\":"+ lux+ "}}";
        data += tempC;
        data += ",\"humi\":";
        data += humidity;
        data += ",\"lux\":";
